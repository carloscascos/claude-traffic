...
def generate_map(routes_gdf, port_gdf=None, output_file='cruise_highway_map.html'):
    ...
    # Create a color map based on tonnage
    ...
    for idx, route in routes_gdf.iterrows():
        ...
        # Calculate color based on gross tonnage
        color = colormap(route['total_gross_tonnage'])
    ...
    <div style="position: fixed; 
        ...
        Mediterranean Cruise Vessel Maritime Highway Map - Sept-Nov 2024
    </div>
    '''
