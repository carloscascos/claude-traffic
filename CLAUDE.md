...
This project is located in /home/proyectos/ccascos/claude-fabric (carloscascos/claude-traffic in github)

## Development Guidelines

When suggesting changes to code:
- Ask before modifying any existing code with options:
  - Yes / this time only
  - Yes / always
  - No / tell me what to do
- Always activate the Python environment first: `source env/bin/activate`
